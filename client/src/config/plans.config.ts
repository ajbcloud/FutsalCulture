...
export const plans: PlanConfig[] = [
  {
    ...
    features: {
      ...
      playerDevelopment: { name: 'Advanced Player Development (Coming Soon)', status: 'not_included' },
  ...
  },
  {
    ...
    features: {
      ...
      playerDevelopment: { name: 'Advanced Player Development (Coming Soon)', status: 'included' },
      calendarIntegration: { name: 'Calendar Integrations', status: 'included' },
