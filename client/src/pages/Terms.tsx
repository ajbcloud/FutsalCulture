      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">3.1 Account Creation</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">3.3 Account Types</h3>
            <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-1">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">4. Subscription Plans and Billing</h2>
            
            <h3 className="text-xl font-medium mb-3 text-foreground">4.1 Plan Types</h3>
            <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-1">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">4.2 Payment Terms</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">4.3 Session Fees</h3>
            <p className="text-muted-foreground mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">8. Safety and Liability</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, SKOREHQ SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION, LOSS OF PROFITS, DATA, USE, OR OTHER INTANGIBLE LOSSES, RESULTING FROM YOUR USE OF THE SERVICE.
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">11. Service Availability</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">12.1 Termination by You</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">12.2 Termination by Us</h3>
            <p className="text-muted-foreground mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">15. Changes to Terms</h2>
            <p className="text-muted-foreground mb-4">
