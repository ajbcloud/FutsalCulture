      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">2.3 Information from Third Parties</h3>
            <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-1">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium mb-3 text-foreground">We may share your information with:</h3>
            <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-1">
